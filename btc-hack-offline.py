...
def print_help():
    print('''BTC-Hack-Offline homepage: https://github.com/DavidMGilbert/btc-hack-offline
BTC-Hack-Offline QA support: https://github.com/DavidMGilbert/btc-hack-offline/issues


Speed test: 
execute 'python3 btc-hack-offline.py time', the output will be the time it takes to bruteforce a single address in seconds


By default this program runs with parameters:
python3 btc-hack-offline.py verbose=0 substring=8
...
if __name__ == '__main__':
    ...
    for arg in sys.argv[1:]:
        ...
        if command == 'help':
            ...
            print('invalid input: ' + command  + '\nrun `python3 btc-hack-offline.py help` for help')
            sys.exit(-1)
